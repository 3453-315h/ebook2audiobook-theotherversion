...
default_engine_settings = {
    ...
    TTS_ENGINES['SUPERTONIC']: {
        ...
        "total_step": 5,
        "speed": 0.3,
        "files": ['tts.json', 'unicode_indexer.json', 'duration_predictor.onnx', 'text_encoder.onnx', 'vector_estimator.onnx', 'vocoder.onnx'],
        "voices": {
            "M1": "Male 1 - Neutral",
            "M2": "Male 2 - Deep",
            "M3": "Male 3 - Young",
            ...
            "F2": "Female 2 - Soft",
            "F3": "Female 3 - Bright",
            "C1": "Child 1 - Young Boy",
            "C2": "Child 2 - Young Girl",
            "E1": "Elder 1 - Wise Male",
            "E2": "Elder 2 - Gentle Female"
        },
...
models = {
    ...
    TTS_ENGINES['SUPERTONIC']: {
        "internal": {
            ...
            "sub": "",
            "voice": "M1",
            "files": default_engine_settings[TTS_ENGINES['SUPERTONIC']]['files'],
            "samplerate": default_engine_settings[TTS_ENGINES['SUPERTONIC']]['samplerate']
        },
        "fast": {
            "lang": "multi",
            "repo": "Supertone/supertonic",

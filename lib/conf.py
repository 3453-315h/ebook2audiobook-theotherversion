...
os.environ['JETSON_PLATFORM'] = 'False'
os.environ['JETSON_MEMORY_OPTIMIZATION'] = 'True'
os.environ['JETSON_TORCH_VERSION'] = '2.2.0'  # Default version
...
default_jetson_url = 'https://www.e-blokos.com/whl/jetson' # Jetson PyTorch repository
...
enable_torch_compile = True  # Enable torch.compile() for model acceleration
enable_cuda_graphs = True   # Enable CUDA graphs for faster inference
enable_memory_profiling = False # Enable memory usage tracking (debug)
enable_performance_monitoring = False # Enable performance metrics tracking (debug)

# Memory management settings
cuda_memory_fraction = 0.9  # Default CUDA memory fraction (0.1-1.0)
batch_size_optimization = True # Enable dynamic batch size optimization
gpu_memory_strategy = "balanced" # "balanced", "aggressive", or "conservative"

# Advanced CUDA settings
cuda_benchmark_mode = True
cuda_deterministic_mode = False
cuda_tf32_enabled = True
cuda_fp16_reduction = True

# Performance thresholds
min_vram_for_optimization = 8.0  # Minimum VRAM in GB for advanced optimizations
max_batch_size = 1024           # Maximum batch size for processing
min_batch_size = 64            # Minimum batch size for processing

# Torch compile settings
torch_compile_mode = "default" # "default", "reduce-overhead", "max-autotune"
torch_compile_dynamic = True  # Enable dynamic shape compilation